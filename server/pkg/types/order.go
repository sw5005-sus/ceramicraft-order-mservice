...
type OrderInfo struct {
	ReceiverFirstName string           `json:"receiver_first_name" binding:"required,max=50"` // 收货人姓名
	ReceiverLastName  string           `json:"receiver_last_name" binding:"required,max=50"`  // 收货人姓名
	ReceiverPhone     string           `json:"receiver_phone" binding:"required,max=20"`      // 收货人电话
	ReceiverAddress   string           `json:"receiver_address" binding:"required,max=255"`   // 收货地址
	ReceiverCountry   string           `json:"receiver_country" binding:"required,max=50"`    // 收货人国家
	ReceiverZipCode   int              `json:"receiver_zip_code" binding:"required"`          // 收货人邮政编码
